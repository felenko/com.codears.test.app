...
public class BackendlessBroadcastReceiver: BroadcastReceiver, IntentService
    { 
  ...
  private static final Map<Integer, PowerManager.PowerManager.WakeLock> activeWakeLocks = new HashMap<>();
